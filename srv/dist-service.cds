...
service DistributionService {
    ...
    entity PlayBackCapability1  as projection on api.YY1_CHARACTERISTIC_AR;
    entity PlayBackCapability2  as projection on api.YY1_CHARACTERISTIC_DT;
    entity PlayBackCapability3  as projection on api.YY1_CHARACTERISTIC_DG;
    entity PlayBackCapability4  as projection on api.YY1_CHARACTERISTIC_MS;
    entity PlayBackCapability5  as projection on api.YY1_CHARACTERISTIC_SF;
    entity PlayBackCapability6  as projection on api.YY1_CHARACTERISTIC_FF;
    entity PlayBackCapability7  as projection on api.YY1_CHARACTERISTIC_ST;
    entity PlayBackCapability8  as projection on api.YY1_CHARACTERISTIC_MFRS;
    entity PlayBackCapability9  as projection on api.YY1_CHARACTERISTIC_LL;
